...
public class Pilot extends Application implements EventHandler<KeyEvent>, TcpConnection.EventHandler {
    ...
    public void handle(KeyEvent event) {
        ...
        if (code == KeyCode.ENTER) {
            ...
            m_Airplane.setYaw(m_Airplane.getYaw() + 0.2f);
        }
            ...
            if (code == KeyCode.W) {
                m_Airplane.setPitch(m_Airplane.getPitch() + 0.2f);
            }
            else if (code == KeyCode.S) {
                m_Airplane.setPitch(m_Airplane.getPitch() - 0.2f);
            }
            else if (code == KeyCode.EQUALS || code == KeyCode.PLUS) {
                m_Airplane.setSpeed(m_Airplane.getSpeed() + 5.0f);
            }
    ...
    public class ViewController implements ChangeListener<Number> {
        ...
        private void update() {
            ...
            final float dashOffsetH = m_Viewport.Height - m_DashViewport.Height + m_DashViewport.Padding;
